...
class photoswiperButtonMenu {
  ...
  exec (editor, value) {
    ...
    editor['openPhotoswiperDialog'](editor)
  }

}

const menuConf = {
  key: 'photoswiper', // 定义 menu key ：要保证唯一、不重复（重要）
  factory () {
    return new photoswiperButtonMenu() // 把 `YourMenuClass` 替换为你菜单的 class
  },
}
