          ...
          <template #panel="{ close }">
            <div class="acgn-filter-popover-body">
              <div class="pt-3 pl-3 pr-3">
                ...
                <div class="mb-2">
                  <div class="text-sm font-medium mb-1">
                    {{ t('common.pageMedia.typeLabel') }}
                  </div>
                  <div class="flex flex-wrap">
                    <div class="mr-1 mb-1">
                      <WUIButton
                        :label="t('common.pageMedia.allTypes')"
                        size="2xs"
                        :variant="
                        ...
                        @click="
                          selectBooktype(
                            {
                              name: t('common.pageMedia.allTypes'),
                              _id: undefined
                            },
                            close
                          )
...
const statusList = computed(() => [
  ...
  {
    label: t('common.pageMedia.bookUnread'),
    value: 1
  },
  {
    label: t('common.pageMedia.bookReading'),
    value: 2
  },
  {
    label: t('common.pageMedia.bookFinished'),
    value: 3
  },
  {
